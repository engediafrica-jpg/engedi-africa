          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap', marginBottom: '8px' }}>
                ...
                {isVerified && (
                  <span style={{ background: '#e8f8f0', border: '1.5px solid #2ecc71', color: '#27ae60', fontSize: '12px', fontWeight: '700', padding: '3px 12px', borderRadius: '20px', display: 'flex', alignItems: 'center', gap: '4px' }}>
                    ✓ EnGedi Verified
                  </span>
                )}
              </div>
